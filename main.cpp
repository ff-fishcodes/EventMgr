...
int main() {
    ...
    api.triggerAlarm("锅炉", 3, "temp_high", true);
    ...
    api.triggerAlarm("锅炉", 3, "temp_high", true);     // Emergency → cooler_fan + cooler_stop
    api.triggerAlarm("冷却塔", 1, "vibration", true);     // Serious → cooler_stop
    api.triggerAlarm("电网", 2, "voltage_high", true);   // Emergency → cooler_stop (level default)
